  ...
  return (
    <header className="bg-gradient-to-r from-fecomercio-navy via-[#023e73] to-fesuper-darkGreen text-white shadow-md border-b border-blue-950/40 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-2.5 sm:py-3.5">
        ...
        {/* Layout Desktop / Tablet (md+) e Mobile (< md) */}
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 md:gap-4">
          
          {/* Top Bar on Mobile: Brand Logos + User Actions */}
          <div className="flex items-center justify-between gap-2.5 sm:gap-4">
            
            <div className="flex items-center gap-2 sm:gap-4">
              <div className="bg-white p-1.5 sm:p-2 rounded-xl shadow-sm flex items-center justify-center h-11 sm:h-16 w-28 sm:w-44">
                <img 
              ...
              <div className="h-7 sm:h-10 w-px bg-white/20"></div>

              <div className="bg-white/10 backdrop-blur-sm p-1 sm:p-1.5 rounded-xl border border-white/15 flex items-center justify-center h-11 sm:h-16 w-28 sm:w-48 overflow-hidden">
                <img 
          ...
          <div className="flex-1 min-w-0 md:px-2">
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
              <span className="bg-fesuper-emerald text-white text-[10px] sm:text-[11px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
                24ª Edição • Arapiraca/AL
              </span>
              <span className="bg-fecomercio-gold text-white text-[10px] sm:text-[11px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
                Relatório Oficial
              </span>
            </div>
            <h1 className="text-sm sm:text-lg md:text-xl font-bold tracking-tight text-white mt-1 leading-snug truncate sm:whitespace-normal">
              Painel Integrado de Satisfação e Resultados
            </h1>
            <p className="text-[11px] sm:text-xs text-slate-200 truncate sm:whitespace-normal">
              Sistema Fecomércio Sesc Senac AL & Associação dos Supermercados de Alagoas (ASA)
            </p>
          </div>

          {/* Desktop Actions & Meta (md+) */}
          <div className="hidden md:flex flex-wrap items-center gap-2 sm:gap-3 shrink-0">
            <div className="hidden lg:flex items-center gap-3.5 text-xs text-slate-200 bg-white/10 px-3 py-2 rounded-xl border border-white/10">
