...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      {isFiltered && (
        <div className="bg-blue-50 border-b border-blue-200 py-1.5 px-4 text-xs text-blue-900 flex items-center justify-between no-print">
          <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
            <div className="flex items-center gap-2 font-medium">
              <Filter className="w-3.5 h-3.5 text-fecomercio-blue" />
              <span>
                Filtro aplicado: 
                ...
                <span className="text-slate-600 ml-1">({stats.filteredCount} respondentes correspondentes)</span>
              </span>
            </div>
            <button 
              onClick={handleResetFilters}
              className="text-xs text-blue-700 hover:text-red-700 font-bold underline flex items-center gap-1"
            >
              <X className="w-3 h-3" />
